...
def create_rating(rating:Rating):
    ...
    return JSONResponse(content={"message":"rating created successfully", "status_code" : 201}, status_code= 201)
...
def update_rating(id:int,data:Rating):
    ...
    return JSONResponse(content={"message": "rating update successfully", "status_code": 200}, status_code=200)
